...
export const HERO_SLIDES: BilingualHeroSlide[] = [
  {
    ...
    imageUrl: '/hero-healthy-bihar.jpg',
    tag: 'Youth & Education',
  ...
  },
  {
    ...
    imageUrl: '/hero-empowered-bihar.jpg',
...
export const DIRECTORS: BilingualDirector[] = [
  {
    ...
    fullBio: 'Chetna Jhamb’s journey is an inspiring story of resilience, self-reliance, social commitment, and leadership. Rooted in Samastipur, Bihar, she received her early education and foundational life lessons in the region. The rich social and cultural heritage of Bihar, particularly the values and sensitivity associated with the Mithila region, has deeply influenced her personality, outlook, and approach to life.\n\nToday, through her hard work, vision, and entrepreneurial spirit, Chetna Jhamb has established a successful business presence in India and overseas. As a successful woman entrepreneur and business leader, she has not only built a strong professional identity for herself but has also created employment opportunities for thousands of people. She believes that the true success of a business is not measured only by financial achievements, but also by the positive impact it creates in the lives of the people associated with it.\n\nAlongside her entrepreneurial journey, Chetna Jhamb has been actively involved in the social sector for the past decade. Through various initiatives focused on education, women’s empowerment, youth development, employment, social awareness, and public service, she has worked with diverse sections of society. Connecting with people at the grassroots level, understanding their needs, and working towards meaningful solutions have remained an important part of her approach.\n\nHer political engagement has also grown alongside her social commitment. At present, she is actively associated with the Bharatiya Janata Party (BJP) and is contributing to the organisation and public service through her active participation. Her focus remains particularly on the development of Samastipur and the wider Mithila region, with emphasis on creating opportunities for youth, strengthening women’s participation, and contributing to the social and economic progress of the region.\n\nToday, Chetna Jhamb is recognised not merely as a successful entrepreneur, but also as a social worker, women leader, and an active public figure committed to people-centric causes. Her journey from the soil of Samastipur to building a presence at the national and international level stands as an example of how strong determination, continuous hard work, and a deep sense of social responsibility can create meaningful change while remaining firmly connected to one’s roots.',
  ...
  },
  {
    ...
    fullBio: 'Dr. Sanjay Mayukh is a senior leader of the Bharatiya Janata Party (BJP), a Member of the Bihar Legislative Council, and an experienced political strategist with a strong background in media and public communication. He has been actively associated with Bihar’s political landscape, organizational affairs, and media management for several years.\n\nHis political journey progressed from organizational responsibilities to a significant role in the BJP’s national media and spokesperson framework. In 2020, he was entrusted with the responsibility of National Media Co-Incharge and National Spokesperson of the BJP, reflecting his experience and expertise in political communication and media management.\n\nDr. Mayukh has also played an important role in Bihar’s legislative and political affairs. He has served as a Member of the Bihar Legislative Council and has continued to remain actively engaged in the state’s political and organizational activities.\n\nAlongside his political responsibilities, Dr. Mayukh has been involved in writing and public discourse. His articles and views have addressed issues related to Bihar’s development, youth, employment, education, women’s empowerment, governance, and the changing socio-political landscape of the state.\n\nWith his combination of political experience, organizational understanding, media expertise, academic background, and public communication skills, Dr. Sanjay Mayukh has emerged as a prominent voice in Bihar’s contemporary political discourse.\n\nAcademic Background: According to his available profile, Dr. Sanjay Mayukh holds a PhD, Master’s degree (MA), and a Post Graduate Diploma in Rural Management.',
  ...
  },
  {
    ...
    fullBio: 'Kundan Kumar Singh is a social worker, political strategist, author, and young entrepreneur, born and brought up in Siwan, Bihar. He received his early education in Patna and completed his graduation and post-graduation from the University of Delhi.\n\nComing from an educationist background, Kundan Kumar Singh has been actively associated with social service, political consultancy, and public-oriented initiatives for the past 8–10 years. He has worked with major political parties across North India, as well as with several Members of Parliament and Ministers, contributing to political strategy, public relations, election campaigns, and political communication.\n\nHe is the Founder of Politico Insights Political Consultancy, a Delhi-based political consultancy working in the areas of political strategy, election management, campaign planning, research, and communication. He is also the Founder of Digikalp Digital Agency and News Insights. In the social sector, he serves as the Managing Trustee of Rudra Charitable Trust and Director of Gaon Samaj Foundation, working on various social and community-oriented initiatives.\n\nAlongside his experience in politics and social development, Kundan Kumar Singh has a keen interest in political writing and analytical discourse on contemporary social and political issues. He is the author of “Siyasatnama — Main Bihar Hoon”, a book that explores Bihar’s political journey, society, changing aspirations, and evolving social consciousness.\n\nHis professional journey reflects a blend of social commitment, political experience, research-oriented thinking, strategic understanding, and grassroots engagement. Through his work, he seeks to strengthen the dialogue between politics and society and encourage greater participation of young people in social and democratic processes.',
